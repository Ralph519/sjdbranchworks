        ...
        <div class="col-xs-12">
          <div class="cardsmall">
            <h2 class="invoice-header">
              <i class="fa fa-file-text-o"></i> Summary of Tickets created per Reported By and Issue Reported
              <br>
            ...
            <div class="col-xs-12 table-responsive">
              <table id="reptable" class="table table-bordered table-striped table-hover">
                <thead>
                  <tr>
                    <th class="text-center" rowspan="2" style="width: 5%;">User Name</th>
                    <th class="text-center" rowspan="2" style="width: 15%;">Full Name</th>
                ...
                <tbody>
                  ...
                  <tr>
                    @foreach($repitem as $column_name => $value)
                      ...
                      ?>
                      @if($column_name != 's_reportby' && $column_name != 'name')

                        <td><a href="{{ route('summarybyreportbyissuerepdetail', ['s_reportby' => $repitem->s_reportby, 'assigntoname' => $repitem->name, 'date1' => $date1, 'date2' => $date2, 'reptype' => $lRepType, 'issuetype' => $lIssueType]) }}">{{$value}}</a></td>
                        <?php
