        ...
        <div class="col-xs-12">
          <div class="cardsmall">
            <h2 class="invoice-header">
              <i class="fa fa-file-text-o"></i> Summary of Tickets by Reported By
              <br>
            ...
            <div class="col-xs-12 table-responsive">
              <table id="reptable" class="table table-bordered table-striped table-hover">
                <thead>
                  <tr>
                    <th class="text-center" style="width: 20%;">Employee Name</th>
                ...
                <tbody>
                  ...
                  <tr>
                    <td>{{$repitem->name}}</td>
                    <td><a href="{{ route('summarybyreportbydetail', ['assignto' => $repitem->s_reportby, 'assigntoname' => $repitem->name, 'date1' => $date1, 'date2' => $date2, 'reptype' => 1]) }}">{{$repitem->totalcnt}}</a></td>
                    <td><a href="{{ route('summarybyreportbydetail', ['assignto' => $repitem->s_reportby, 'assigntoname' => $repitem->name, 'date1' => $date1, 'date2' => $date2, 'reptype' => 2]) }}">{{$repitem->resolvedcnt}}</a></td>
                    <td><a href="{{ route('summarybyreportbydetail', ['assignto' => $repitem->s_reportby, 'assigntoname' => $repitem->name, 'date1' => $date1, 'date2' => $date2, 'reptype' => 3]) }}">{{$repitem->opencnt}}</a></td>
