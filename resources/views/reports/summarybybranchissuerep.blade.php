              ...
              <table id="reptable" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center"><a href="{{ route('summarybybranchissuerepdetail', ['brnccode' => $repitem->s_brnccode, 'brncname' => $repitem->s_brncname, 'date1' => $date1, 'date2' => $date2, 'reptype' => 1, 'issuetype' => 1]) }}">{{$repitem->totalcnt}}</a></td>
                    @if ($repitem->issuetype1_open != '0')
                      <td class="text-center"><a href="{{ route('summarybybranchissuerepdetail', ['brnccode' => $repitem->s_brnccode, 'brncname' => $repitem->s_brncname, 'date1' => $date1, 'date2' => $date2, 'reptype' => 3, 'issuetype' => 1]) }}">{{$repitem->issuetype1_open}}</a></td>
                    @else
                      <td></td>
                    @endif

                    @if ($repitem->issuetype1_rslv!= '0')
                      <td class="text-center"><a href="{{ route('summarybybranchissuerepdetail', ['brnccode' => $repitem->s_brnccode, 'brncname' => $repitem->s_brncname, 'date1' => $date1, 'date2' => $date2, 'reptype' => 2, 'issuetype' => 1]) }}">{{$repitem->issuetype1_rslv}}</a></td>
                    @else
                      <td></td>
                    @endif

                    @if ($repitem->issuetype2_open != '0')
                      <td class="text-center"><a href="{{ route('summarybybranchissuerepdetail', ['brnccode' => $repitem->s_brnccode, 'brncname' => $repitem->s_brncname, 'date1' => $date1, 'date2' => $date2, 'reptype' => 3, 'issuetype' => 2]) }}">{{$repitem->issuetype2_open}}</a></td>
                    @else
                      <td></td>
                    @endif

                    @if ($repitem->issuetype2_rslv!= '0')
                      <td class="text-center"><a href="{{ route('summarybybranchissuerepdetail', ['brnccode' => $repitem->s_brnccode, 'brncname' => $repitem->s_brncname, 'date1' => $date1, 'date2' => $date2, 'reptype' => 2, 'issuetype' => 2]) }}">{{$repitem->issuetype2_rslv}}</a></td>
                    @else
                      <td></td>
                    @endif

                    @if ($repitem->issuetype3_open != '0')
                      <td class="text-center"><a href="{{ route('summarybybranchissuerepdetail', ['brnccode' => $repitem->s_brnccode, 'brncname' => $repitem->s_brncname, 'date1' => $date1, 'date2' => $date2, 'reptype' => 3, 'issuetype' => 3]) }}">{{$repitem->issuetype3_open}}</a></td>
                    @else
                      <td></td>
                    @endif

                    @if ($repitem->issuetype3_rslv!= '0')
                      <td class="text-center"><a href="{{ route('summarybybranchissuerepdetail', ['brnccode' => $repitem->s_brnccode, 'brncname' => $repitem->s_brncname, 'date1' => $date1, 'date2' => $date2, 'reptype' => 2, 'issuetype' => 3]) }}">{{$repitem->issuetype3_rslv}}</a></td>
                    @else
                      <td></td>
                    @endif

                    @if ($repitem->issuetype4_open != '0')
                      <td class="text-center"><a href="{{ route('summarybybranchissuerepdetail', ['brnccode' => $repitem->s_brnccode, 'brncname' => $repitem->s_brncname, 'date1' => $date1, 'date2' => $date2, 'reptype' => 3, 'issuetype' => 4]) }}">{{$repitem->issuetype4_open}}</a></td>
                    @else
                      <td></td>
                    @endif

                    @if ($repitem->issuetype4_rslv!= '0')
                      <td class="text-center"><a href="{{ route('summarybybranchissuerepdetail', ['brnccode' => $repitem->s_brnccode, 'brncname' => $repitem->s_brncname, 'date1' => $date1, 'date2' => $date2, 'reptype' => 2, 'issuetype' => 4]) }}">{{$repitem->issuetype4_rslv}}</a></td>
                    @else
                      <td></td>
                    @endif
                  </tr>
