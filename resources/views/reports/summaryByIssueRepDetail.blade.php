        ...
        <div class="col-xs-12">
          <div class="cardsmall">
            <h2 class="invoice-header">
              <i class="fa fa-file-text-o"></i> Details of Tickets created per Issue Reported -
                                    <strong>{{$reptitle.$s_issuetypedesc.' Issue'}}</strong>
              <br>
            ...
            <div class="col-xs-12 table-responsive">
              <table id="reptable" class="table table-bordered table-striped table-hover" style="font-size: 12px;">
                <thead>
                  <tr>
